...
export const soundscapeConfig = {
  ...
  ambient: {
    source: assetPath('audio/bgs/BGS-ambientOS.mp3'),
    volume: 0.6,
  },
  glitch: {
    sources: [
      assetPath('audio/bgs/BGS-glitch_a.mp3'),
      assetPath('audio/bgs/BGS-glitch_b.mp3'),
      assetPath('audio/bgs/BGS-glitch_c.mp3'),
      assetPath('audio/bgs/BGS-glitch_d.mp3'),
      assetPath('audio/bgs/BGS-glitch_e.mp3'),
    ],
    volume: 0.58,
    maxActive: 2,
    minDelayMs: 4000,
