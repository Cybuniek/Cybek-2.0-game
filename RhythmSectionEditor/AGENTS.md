...
This is a **WinUI 3** desktop application built on the **Windows App SDK**. This repo has been converted into an **unpackaged developer tool** (`<WindowsPackageType>None</WindowsPackageType>`, `<EnableMsixTooling>false</EnableMsixTooling>`) and supports x86, x64, and ARM64 architectures.
