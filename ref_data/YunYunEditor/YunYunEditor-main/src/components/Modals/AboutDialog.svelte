  ...
  const changelog: ChangelogEntry[] = [
    {
      version: '0.4.1',
      changes: [
        'Added support for the new "List Artist" field, shown beneath the song title in the in-game song list.',
        'Added support for the new "Icon" field, an optional song icon (.png or .jpg) that displays in-game when the song is selected.',
      ],
    },
    {
      version: '0.4.0',
